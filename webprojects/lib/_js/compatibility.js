...
IF_NOT_MODERN
	...
	//credit to MDN, though I (sjelin) added "; secure" code
	if (!window.localStorage) (function() {
		var sec = location.href == "https:" ? "; secure" : "";
		try {
		  Object.defineProperty(window, "localStorage", new (function () {
			...
			Object.defineProperty(oStorage, "setItem", {
			  value: function (sKey, sValue) {
				if(!sKey) { return; }
				document.cookie = escape(sKey) + "=" + escape(sValue) + "; expires=Tue, 19 Jan 2038 03:14:07 GMT; path=/" + sec;
			  },
			  writable: false,
			  configurable: false,
			  enumerable: false
			...
			Object.defineProperty(oStorage, "removeItem", {
			  value: function (sKey) {
				if(!sKey) { return; }
				document.cookie = escape(sKey) + "=; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/" + sec;
			  },
			  writable: false,
			  configurable: false,
			  enumerable: false
